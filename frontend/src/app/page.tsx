...
export default function Home() {
  return (
    <div
      className={`flex flex-col sm:items-center sm:justify-center min-h-screen p-8 pb-20 sm:p-20 ${silkscreen.className}`}
    >
      <FlipWords
        words={["Hello", "Bonjour", "Hola", "Ciao", "Hallo", "Salam", "Hej", "Aloha"]}
        duration={3000}
        className="font-bold text-4xl sm:text-5xl pb-10 text-center font-[Noto Sans Tamil, Noto Sans Telugu, Noto Sans Kannada, Noto Sans Malayalam, sans-serif]"
      />
